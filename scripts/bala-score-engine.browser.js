// bala-score-engine.browser.js — IIFE build for browser use
// Generated from bala-score-engine.js (B44). No require() calls — pure JS.
// Exports window.BALAScoreEngine = { computeBALAScore, ALL_SIGNAL_KEYS, CONFIDENCE, EMERGENCY_REPLY }
/* eslint-disable */
(function () {
'use strict';
...
// Browser export — consumed by app.js as window.BALAScoreEngine
  window.BALAScoreEngine = {
    computeBALAScore,
    ALL_SIGNAL_KEYS,
    CONFIDENCE,
    EMERGENCY_REPLY,
