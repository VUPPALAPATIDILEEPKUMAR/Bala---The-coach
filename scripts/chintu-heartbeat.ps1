...
$null = $stepResults.Add((Run-LocalStep -Label "Connector readiness" -Runner "node" -Target "scripts\chintu-connector-send.js" -Arguments @("--check")))
...
$connectorReadinessStatus = Get-FileStatus "CHINTU_OUTBOX/latest_connector_readiness.json"
...
$null = $reportLines.Add("| Connector readiness JSON | $connectorReadinessStatus |")
...
$heartbeatJson = [ordered]@{
    ...
    connector_readiness_status = $connectorReadinessStatus
